...
export const FoodTableContainer = ({
    children,
    handleInput,
    inputValue,
    setAddModal,
    ...
    return(
        ...
        {pageFor === 'homepage'
            ...
            <h3 className="card-title text-nowrap fs-2 fw-semibold">Daftar Makanan</h3>
            <Link to={'/food'} className=" text-decoration-none text-nowrap fw-semibold">Lihat Semua</Link>
            </div>
